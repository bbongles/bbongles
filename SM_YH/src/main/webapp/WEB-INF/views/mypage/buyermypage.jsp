					...
					<form action="#" method="post">
						...
						<fieldset>
							<div class="control-group">
								<label class="control-label"><a href="#" id="test">주문 배송 조회</a></label>

							</div>
							<div class="control-group">
								<label class="control-label"><a href="#">주문 내역</a></label>
							</div>
							<div class="control-group">
...
$(document).ready(function() {
	...
	function getAllbuylist() {
		var url = '/shop05/mypage/userid/all/' + b_id;
		$.getJSON(url, function(data) {
			var td = ''; 
			$(data).each(function(){
				td += '<td class="buyerlist">' + this.count +'건'+ '</td>'
			});
			$('#buyer').html(td);
		});
	};
